 class ReactionModel {
  ...
  ReactionModel({this.status, this.data});

  ReactionModel.fromJson(Map<String, dynamic> json) {
    status = json['status'];
    data = json['data'] != null ? new Reactions.fromJson(json['data']) : null;
  }
...
class Reactions {
  ...
  Reactions({this.feelingPercentage, this.feelingList, this.videoArr});
